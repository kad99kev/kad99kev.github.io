...
class Content extends React.Component {
  render() {
    const { title, content, date, tags, translations } = this.props

    return (
      <section>
        {(title || tags || date || translations) && (
          <ContentHeader title={title} date={date} tags={tags} translations={translations} />
        )}
